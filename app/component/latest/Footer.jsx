...
function ContactFloat() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[9999] flex flex-col items-center gap-2.5 md:bottom-6 md:right-6 md:gap-3">
      <div className="relative h-11 w-11 md:h-14 md:w-14">
        ...
        >
          ...
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="relative z-[1] h-5 w-5 text-[#000080] drop-shadow-[0_1px_2px_rgba(255,255,255,0.65)] transition-transform duration-300 group-hover:scale-105 md:h-7 md:w-7"
            aria-hidden="true"
          >
      ...
      <a
        ...
        className="flex h-11 w-11 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-transform hover:scale-105 md:h-14 md:w-14"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
...
const MediaWorldText = () => (
  <span
    className="inline-flex max-w-full shrink-0 items-baseline gap-[3px] whitespace-nowrap !text-[clamp(0.7rem,6.6vw,3.05rem)] sm:gap-[6px] sm:!text-[32px] md:!text-[44px] lg:gap-2 lg:!text-[56px] xl:!text-[74px]"
      ...
      >
        ...
        >
          ...
          <div
            ...
            className="relative z-[2] mx-auto flex w-full max-w-[1320px] flex-nowrap items-baseline justify-center gap-x-1 px-1 text-center whitespace-nowrap sm:gap-x-2 sm:px-2 md:gap-x-3 md:px-6 lg:justify-between lg:gap-2"
          >
            <span
              data-footer-ritz
              style={brandFontStyle}
              className="footer-brand-flag inline-block shrink-0 whitespace-nowrap !text-[clamp(0.7rem,6.6vw,3.05rem)] sm:!text-[32px] md:!text-[40px] lg:will-change-transform lg:!text-[56px] xl:!text-[74px]"
            >
              RITZ
            </span>
