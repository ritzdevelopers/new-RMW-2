...
const brandTextStyle = {
  ...
  textTransform: "uppercase",
  color: "transparent",
  backgroundImage: "url('/new-theme/new-theme4.jpg')",
...
function ContactFloat() {
  ...
  const labelClass =
    "max-w-0 overflow-hidden whitespace-nowrap pr-0 text-[12px] font-semibold tracking-wide text-white opacity-0 transition-all duration-300 ease-out group-hover:max-w-[5.5rem] group-hover:pr-3.5 group-hover:opacity-100 group-focus-visible:max-w-[5.5rem] group-focus-visible:pr-3.5 group-focus-visible:opacity-100";

  const iconWrapClass =
    "relative z-[1] flex h-[41px] w-[41px] shrink-0 items-center justify-center";
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end gap-3">
      ...
      <a
        ...
        aria-label="WhatsApp"
        className="group flex h-[41px] w-[41px] items-center justify-start overflow-hidden rounded-full bg-[#25D366] shadow-lg transition-[width,box-shadow,transform] duration-300 ease-out hover:w-[140px] hover:shadow-xl focus-visible:w-[140px] active:scale-[0.98]"
        style={{ fontFamily: sequelFontFamily }}
      >
        <span className={iconWrapClass}>
          <svg
...
const MediaWorldText = () => (
  <span className="inline-flex max-w-full shrink-0 items-baseline gap-[4px] whitespace-nowrap !text-[clamp(1.25rem,8vw,1.75rem)] sm:gap-[6px] sm:!text-[32px] md:!text-[44px] lg:gap-2 lg:!text-[56px] xl:!text-[74px]">
    <span style={brandTextStyle}>MEDIA</span>
    <span style={brandTextStyle}>WORLD</span>
  </span>
);
