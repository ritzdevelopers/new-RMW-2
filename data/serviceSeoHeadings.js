...
export const serviceSeoHeadingsBySlug = {
  ...
  "3d-rendering": {
    h1: ["3D Rendering Services"],
    sections: [
      { h2: "3D Exterior Rendering" },
      { h2: "3D Interior Rendering" },
      { h2: "Aerial & Township 3D Visualization" },
      { h2: "3D Floor Plan Rendering" },
      { h2: "Amenity & Landscape Rendering" },
      {
        h2: "Why Choose Our 3D Rendering Services?",
        h3: [
      ...
      },
      {
        ...
        h3: [
          ...
          "3D Modelling & Scene Development",
          "Materials, Textures & Lighting",
          "Camera Composition & Visualization",
          "Rendering & Post-Production",
          "Review & Final Delivery",
        ],
      },
      {
        h2: "3D Rendering Services for Different Industries",
        h3: [
      ...
      {
        h2: "Applications of 3D Rendering",
        h3: [
      ...
      {
        h2: "Frequently Asked Questions About 3D Rendering",
        h3: [
          "What Is 3D Rendering?",
          "What Is Architectural Visualization?",
          "Can You Create Renders for Properties That Are Not Yet Built?",
          "What Files Are Required for 3D Rendering?",
          "How Long Does a 3D Rendering Project Take?",
          "Can 3D Renders Be Used for Real Estate Marketing?",
          "Do You Provide 3D Rendering Services Across India?",
        ],
      },
      { h2: "Bring Your Vision to Life with Ritz Media World" },
    ],
  },
};
